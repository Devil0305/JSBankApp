...
public class JsonUtils {
	...
	public static <T> Map<String, T> json2map2(String jsonStr, Class<T> clazz) throws Exception {
		Map<String,  Object> map = objectMapper.readValue(jsonStr,new TypeReference<Map<String, T>>() {});
		Map<String, T> result = new HashMap<String, T>();
